...
### Added
- `lint_on_save` config toggle to enable/disable automatic linting on file save (default: enabled)

## [2.6.0] - 2026-02-26

### Removed
- `ruff_shortcut` and `pyright_shortcut` config params (shortcuts are now managed centrally via Edit > Key Shortcuts)
